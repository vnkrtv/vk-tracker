...
urlpatterns = [
    ...
    url(r'^add_filter_2/$', views.get_new_filter_region,             name='get_new_filter_region'),
    url(r'^add_filter_3/$', views.get_new_filter_cities,             name='get_new_filter_cities'),
    url(r'^add_filter_4/$', views.get_new_filter_universities,       name='get_new_filter_universities'),
